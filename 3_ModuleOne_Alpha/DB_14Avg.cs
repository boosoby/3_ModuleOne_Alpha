...
namespace _3_ModuleOne_Alpha
{
    ...
    class DB_14Avg
    {
        ...
        {
            string query = "SELECT quantity as 'Количество',  aver as 'Средний чек', sum as 'Сумма', managers.full_name as 'ФИО' from averag_m\r\njoin managers on managers.idmanagers = averag_m.idmanagers";
