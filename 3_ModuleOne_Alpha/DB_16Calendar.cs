...
namespace _3_ModuleOne_Alpha
{
    ...
    class DB_16Calendar
    {
        ...
        //Insert statement
        public void Insert(string login, string pass, string address, string name)
        {
            string query = $"INSERT INTO calendar_conf (login, pass, address, name) VALUES('{login}', '{pass}', '{address}', '{name}')";
